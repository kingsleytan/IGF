...
(function() {
  var flashMessagesFunctions;

  flashMessagesFunctions = function() {
    var clearFlashMessages;
    clearFlashMessages = function() {
      setTimeout(function() {
        return $('.flash-messages').addClass('fadeOut');
      }, 5000);
      return setTimeout(function() {
        return $('#flash-messages-container').html("");
      }, 5000);
    };
...
(function() {
  var imagePreviewFunctions;

  imagePreviewFunctions = function() {
    return $('.image-uploader').on('change', function(event) {
